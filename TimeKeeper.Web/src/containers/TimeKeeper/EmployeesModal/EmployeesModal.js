...
import {fetchEmployee, employeeEditCancel, employeePut} from '../../../store/actions/index'
...
const EmployeesModal = (props) => {
    const { classes, open, employee, id, mode, selected } = props;
    const { fetchEmployee, employeeEditCancel, employeePut } = props;
    let rows = []
...
export default connect(mapStateToProps, {fetchEmployee, employeeEditCancel, employeePut})(withStyles(styles)(EmployeesModal));
