...
const teamCard = props => (
    <div className={classes.TeamCard}>
        ...
        <span className={classes.Label} style={{ backgroundImage: props.r === 'FE' ? 'radial-gradient(circle, #32aedc, #00bade, #00c5db, #00cfd5, #00d9ca)' : props.r === 'BE' ? 'radial-gradient(circle, #c25e5e, #b76064, #ac6169, #a0636c, #93656e)' : props.r === 'QA' ? 'radial-gradient(circle, #00b465, #24a460, #31945c, #398457, #3e7552)' : 'radial-gradient(circle, #2f4858, #496070, #637988, #7f93a2, #9baebc)' }}></span>
