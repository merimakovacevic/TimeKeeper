...
namespace TimeKeeper.DAL
{
    public class UnitOfWork : IDisposable
    {
       ...
       // public IRepository<Employee> Employees => _employees ?? (_employees = new EmployeesRepository(_context));
        public IRepository<Employee> Employees => _employees ?? (_employees = new Repository<Employee>(_context));
        ...
        public IRepository<PricingStatus> PositionStatuses => _pricingStatuses ?? (_pricingStatuses = new Repository<PricingStatus>(_context));
