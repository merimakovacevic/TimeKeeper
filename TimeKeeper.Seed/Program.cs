...
namespace TimeKeeper.Seed
{
    internal class Program
    {
        ...
        {
            FileInfo fileStatuses = new FileInfo(@"C:\Projects\TK_Crud\Charlie\TimeKeeper.Seed\LegacyDatabase\TimeKeeperStatuses.xlsx");
            FileInfo file = new FileInfo(@"C:\Projects\TK_Crud\Charlie\TimeKeeper.Seed\LegacyDatabase\TimeKeeper.xlsx");
